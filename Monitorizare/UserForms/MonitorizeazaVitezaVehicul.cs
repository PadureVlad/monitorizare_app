...
{
    public partial class MonitorizeazaVitezaVehicul : Form
    {
        ...
        public MonitorizeazaVitezaVehicul()
        {
            InitializeComponent();
        ...
        private void MonitorizeazaVitezaVehicul_Load(object sender, EventArgs e)
        {
            try
            {
                LoadVehicule();
