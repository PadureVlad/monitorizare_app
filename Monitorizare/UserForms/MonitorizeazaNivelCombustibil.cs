...
{
    public partial class MonitorizeazaNivelCombustibil : Form
    {
        ...
        public MonitorizeazaNivelCombustibil()
        {
            InitializeComponent();
        ...
        private void DisplayVehicule()
        {
            ...
            lbResult.Text = "Avertizare! Dacă nivelul de combustibil al vehiculului este mai mic de 5 l, vă rugăm să mergeți urgent la benzinăria de pe strada ”Mihai Viteazul 23”.";
        }
        ...
        private void MonitorizeazaNivelCombustibil_Load(object sender, EventArgs e)
        {
            try
            {
                LoadVehicule();
