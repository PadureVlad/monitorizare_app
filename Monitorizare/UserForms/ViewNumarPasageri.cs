...
{
    public partial class ViewNumarPasageri : Form
    {
        ...
        private void DisplayVehicule()
        {
            ...
            {
                double gradOcupare = ((double)vehicul.NrCalatori / 25) * 100;
                ...
                listViewItem.SubItems.Add(gradOcupare.ToString() + " %");
        ...
        private void ViewNumarPasageri_Load(object sender, EventArgs e)
        {
            try
            {
                LoadVehicule();
