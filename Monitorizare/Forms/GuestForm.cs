...
namespace Monitorizare.Forms
{
    public partial class GuestForm : Form
    {
        ...
        {
            MessageBox.Show("Sunteți in modul oaspete!\nPentru a vă utiliza de opțiunile aplicației conectați-vă sau creeați un cont nou in forma de logare!", "Restricționat!", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        }
    }
}
